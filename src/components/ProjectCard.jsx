...
const ProjectCard = ({ title, link, linkDisplay, logoImg, logoElement }) => {
  return (
    <main className="cursor-pointer hover:transform hover:-translate-y-2 transition-all duration-300 dark:border-[2px] dark:border-[#242424] rounded-[.2rem] shadow-sm">
      ...
      <div className="w-full p-[2em] bg-white dark:bg-[#242424] rounded-b-[.2rem]">
